...
var requestURL = 'http://htmlpreview.github.io/?https://github.com/alexandreolemos/dicionario/blob/master/dictionary.json';
var request = new XMLHttpRequest();
request.open('GET', requestURL);
request.responseType = 'json';
request.send();
request.onload = function() {
  var dictionaryWordsJson = request.response;
